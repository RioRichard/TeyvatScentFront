...
export function OutsideForgetPass() {
                        ...
                        <form id="Forgot"  onSubmit={(e) => submit(e)}>
                            <div className="login">
                                <div className="group">
                                    ...
                                    <input id="email" style={{ minWidth:'100%'}} type="text" className="input" placeholder="Nhập Email của bạn" name="Email"  onChange={onChangeStaffEmail}/>
                                ...
                                <div className="foot"> <a href="/adminlogin">Đăng nhập</a> </div>
